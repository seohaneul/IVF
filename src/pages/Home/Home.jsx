    ...
    return (
        <div className="home-container fade-in">
            ...
            <section className="hero-simple">
                <img src={logo} alt="IVF Logo" className="logo-main" />
                <p className="subtitle">
                    우리는 캠퍼스와 세상 속에서 하나님의 통치를 실현하고자 하는 <br />
                    복음주의 학생운동 단체, <span className="bold">IVF</span>입니다.
                </p>
            </section>
            ...
            <footer className="footer-simple pb-fixed">
                <p>&copy; 2026 IVF KOREA. All rights reserved.</p>
            </footer>
